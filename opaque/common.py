...
def pbkdf(pwd):
    ...
    salt = b'\x00' * _sage_const_16 

    n = _sage_const_2  ** _sage_const_14   # 2 ** 20
    r = _sage_const_8 
    p = _sage_const_1 

    kdf = Scrypt(salt=salt, length=_sage_const_32 , n=n, r=r, p=p, backend=default_backend())
